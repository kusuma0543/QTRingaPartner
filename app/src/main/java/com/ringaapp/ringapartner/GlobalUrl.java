...
class GlobalUrl {
    public static String partner_signup="http://quaticstech.in/projecti1andro/android_partner_signup.php";
    public static String partner_login="http://quaticstech.in/projecti1andro/android_partner_login.php";
    public static String partner_otpverify="http://quaticstech.in/projecti1andro/android_partner_otpverify.php";
    public static String partner_forgorpass="http://quaticstech.in/projecti1andro/android_partner_forgotpas.php";
    public static String partner_resetpas="http://quaticstech.in/projecti1andro/android_partner_resetpas.php";
    public static String partner_resendotp="http://quaticstech.in/projecti1andro/android_partner_resendotp.php";
    public static String partner_imageupload="http://quaticstech.in/projecti1andro/android_partner_imageuploader.php";
    public static String partner_docv_upload="http://quaticstech.in/projecti1andro/android_partner_docupload.php";
    public static String partner_placepick="http://quaticstech.in/projecti1andro/android_partner_placepick.php";
    public static String partner_imageret="http://quaticstech.in/projecti1andro/android_partner_imageret.php";
    public static String partner_docret="http://quaticstech.in/projecti1andro/android_partner_docret.php";
    public static String partner_catsel_spinner="http://quaticstech.in/projecti1andro/android_partner_spinnercategories.php";
    public static String partner_subcatsel_spinner="http://quaticstech.in/projecti1andro/android_partner_subcategsersel_spinner.php";
